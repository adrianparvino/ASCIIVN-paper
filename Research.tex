...
the online test developed in \cite{onlinetest} will serve as the basis of the the paper test which will is attached as \hyperref[sec:org6a8f1f8]{Appendix A}.

\subsubsection{\citetitle{bornat2008mental}}
\label{sec:org0d9d8f0}
