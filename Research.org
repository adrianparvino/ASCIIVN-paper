...
|---------------------+------------+--------------+-------+-------|
| Equality symbol (=) |          3 |           17 |    17 |    37 |
| Arrow symbol (<-)   |          2 |           14 |    17 |    33 |
| Total               |          5 |           31 |    34 |    70 |
|---------------------+------------+--------------+-------+-------|
|---------------------+------------+--------------+-------+-------|
...
the independence between equality symbol (=) and the arrow symbol (<-) have a p-value of 0.9339,
...
testing that the true odds ratio is less than 1 gives a p-value of 0.7532,
...
the researchers believe that this would result in a more even statistics between consistent and inconsistent groups.
