...
the generated ASCII art is very noisy. Furthermore, we only showed a
single sample out of the sets of images that we actually
generated. 
...
Furthermore, the program is very robust too, even when given 9144 images, none crashed the program nor failed to render.
